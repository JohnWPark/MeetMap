...
queryCtrl.controller('queryCtrl', function($scope, $log, $http, $rootScope, geolocation, gservice){
  ...
  // Get coordiinates based on mouse click.  When a click event is detected...
  $rootScope.$on("clicked", function(){

    // Run the gservice functions associated with identifying coordiinates
  ...
  $scope.queryUsers = function(){
    ...
    $http.post('/query', queryBody)
      ...
      .success(function(queryResults){
        ...
        // Pass the filtered results to the Google maps service and refresh the map
